#!/usr/bin/python3
'''Contains places_amenities view for API.'''
...
def handle_places_amenities(place_id=None, amenity_id=None):
    '''handler for the places endpoint.'''
    handlers = {
...
def get_place_amenities(place_id=None, amenity_id=None):
    '''Gets the amenities of a place with id.'''
    if place_id:
...
def remove_place_amenity(place_id=None, amenity_id=None):
    '''Removes an amenity id from a place id.'''
